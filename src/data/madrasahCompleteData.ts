...
export const TABUNGAN_SANTRI_LIST: TabunganSantri[] = [
  {
    ...
    noInduk: '2024.01.001',
    nisn: '3145678901',
    noRekening: 'TAB-2024-001',
    namaSantri: 'Ahmad Faiz Al-Faruq',
    nama: 'Ahmad Faiz Al-Faruq',
    kelas: 'Kelas 1',
    foto: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=250&auto=format&fit=crop&q=80',
    namaWali: 'H. Lukman Hakim, S.T.',
    noWaWali: '0812-4455-6677',
    ...
    riwayat: [
      { 
        ...
        pembayarPenarik: 'H. Lukman Hakim (Wali)',
      ...
      { 
        ...
        kategori: 'Uang Saku', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Ahmad Faiz',
        idKuitansi: 'KWT-TAB-20260808-05',
        keterangan: 'Setoran Uang Saku Mingguan' 
      },
      { 
        id: 'rw-3', 
  ...
  },
  {
    ...
    noInduk: '2023.02.015',
    nisn: '3134567892',
    noRekening: 'TAB-2023-015',
    namaSantri: 'Fathir Azzam Robbani',
    nama: 'Fathir Azzam Robbani',
    kelas: 'Kelas 2',
    foto: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=250&auto=format&fit=crop&q=80',
    namaWali: 'Drs. Supriyanto',
    noWaWali: '0813-8899-0011',
    programTabungan: 'Kitab & ATK',
    status: 'Aktif',
    jumlahTabungan: 680000,
    totalTabungan: 680000,
    tanggalBuka: '17 Juli 2023',
    terakhirTransaksi: '18 Agustus 2026',
    terakhirUpdate: '18 Agustus 2026',
    riwayat: [
      { 
        id: 'rw-201', 
        ...
        kategori: 'Setoran Awal', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Drs. Supriyanto',
        idKuitansi: 'KWT-TAB-20260710-03',
        keterangan: 'Tabungan Paket Kitab Pegon Semester Ganjil' 
      },
      { 
        id: 'rw-202', 
        ...
        kategori: 'Uang Saku', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Fathir Azzam',
        idKuitansi: 'KWT-TAB-20260725-08',
      ...
      { 
        ...
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Fathir Azzam',
        idKuitansi: 'KWT-TAB-20260818-09',
        keterangan: 'Pembelian Kamus & Buku Pegon di KOPAS' 
      }
    ]
  },
  {
    ...
    noInduk: '2022.03.021',
    nisn: '3123456783',
    noRekening: 'TAB-2022-021',
    namaSantri: 'Zaidan Ahsanul Hadi',
    nama: 'Zaidan Ahsanul Hadi',
    kelas: 'Kelas 3',
    foto: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=250&auto=format&fit=crop&q=80',
    namaWali: 'Bpk. Mahfudz Shiddiq',
    noWaWali: '0858-1234-5678',
    programTabungan: 'Qurban',
    status: 'Aktif',
    jumlahTabungan: 950000,
    totalTabungan: 950000,
    tanggalBuka: '18 Juli 2022',
    terakhirTransaksi: '14 Agustus 2026',
    terakhirUpdate: '14 Agustus 2026',
    riwayat: [
      { 
        id: 'rw-301', 
        ...
        kategori: 'Qurban', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Bpk. Mahfudz Shiddiq',
        idKuitansi: 'KWT-TAB-20260705-02',
        keterangan: 'Angsuran 1 Tabungan Qurban Santri' 
      },
      { 
        id: 'rw-302', 
        ...
        kategori: 'Qurban', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Zaidan Ahsanul Hadi',
        idKuitansi: 'KWT-TAB-20260814-11',
        keterangan: 'Angsuran 2 Tabungan Qurban Santri' 
      }
    ]
  },
  {
    ...
    namaSantri: 'Muhammad Rayhan Pratama',
    nama: 'Muhammad Rayhan Pratama',
    kelas: 'Kelas 4',
    foto: 'https://images.unsplash.com/photo-1544717305-2782549b5136?w=250&auto=format&fit=crop&q=80',
    namaWali: 'H. Bambang Setyawan, S.E.',
    noWaWali: '0812-3456-7890',
    programTabungan: 'Reguler/Saku',
    status: 'Aktif',
    ...
    riwayat: [
      { 
        ...
        kategori: 'Uang Saku', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'H. Bambang Setyawan',
      ...
      { 
        ...
        kategori: 'Kitab & ATK', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Muhammad Rayhan',
        idKuitansi: 'KWT-TAB-20260728-04',
        keterangan: 'Beli Kitab Kuning & Seragam KOPAS' 
      },
      { 
        id: 'rw-6', 
  ...
  },
  {
    ...
    noInduk: '2020.05.045',
    nisn: '3101234565',
    noRekening: 'TAB-2020-045',
    namaSantri: 'Ibrahim Malik Al-Kindi',
    nama: 'Ibrahim Malik Al-Kindi',
    kelas: 'Kelas 5',
    foto: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=250&auto=format&fit=crop&q=80',
    namaWali: 'Bpk. Agus Santoso',
    noWaWali: '0877-2233-4455',
    programTabungan: 'Reguler/Saku',
    status: 'Aktif',
    jumlahTabungan: 820000,
    totalTabungan: 820000,
    tanggalBuka: '13 Juli 2020',
    terakhirTransaksi: '12 Agustus 2026',
    ...
    riwayat: [
      { 
        ...
        kategori: 'Setoran Awal', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Bpk. Agus Santoso',
        idKuitansi: 'KWT-TAB-20260701-05',
        keterangan: 'Simpanan Uang Saku Awal Semester' 
      },
      { 
        id: 'rw-502', 
        ...
        kategori: 'Kesehatan', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Ibrahim Malik',
        idKuitansi: 'KWT-TAB-20260720-02',
        keterangan: 'Biaya Periksa & Vitamin Poskestren' 
      },
      { 
        id: 'rw-503', 
        ...
        kategori: 'Uang Saku', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Ibu Maryani',
        idKuitansi: 'KWT-TAB-20260812-14',
        keterangan: 'Tambahan Uang Saku Bulanan' 
      }
    ]
  },
  {
    ...
    noInduk: '2019.06.050',
    nisn: '3099876546',
    noRekening: 'TAB-2019-050',
    namaSantri: 'Muhammad Hilman Farisi',
    nama: 'Muhammad Hilman Farisi',
    kelas: 'Kelas 6',
    foto: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=250&auto=format&fit=crop&q=80',
    namaWali: 'K.H. Masruri Yusuf',
    noWaWali: '0813-7788-9900',
    programTabungan: 'Haflah & Wisuda',
    status: 'Aktif',
    jumlahTabungan: 2100000,
    totalTabungan: 2100000,
    tanggalBuka: '15 Juli 2019',
    terakhirTransaksi: '17 Agustus 2026',
    ...
    riwayat: [
      { 
        ...
        nominal: 1000000, 
        saldoSebelum: 0, 
        saldoSesudah: 1000000, 
        kategori: 'Haflah & Wisuda', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'K.H. Masruri Yusuf',
        idKuitansi: 'KWT-TAB-20260701-01',
        keterangan: 'Tabungan Biaya Haflah & Wisuda Santri' 
      },
      { 
        id: 'rw-8', 
        ...
        saldoSesudah: 2100000, 
        kategori: 'Haflah & Wisuda', 
        petugas: 'Ustzh. Nur Laili', 
        pembayarPenarik: 'Hj. Kholisoh',
        idKuitansi: 'KWT-TAB-20260817-06',
        keterangan: 'Pelunasan Tabungan Akhirussanah & Wisuda' 
      }
    ]
  }
];
