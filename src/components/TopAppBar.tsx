...
import { Bell, Search, ShieldCheck, QrCode, Menu } from 'lucide-react';
      ...
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <button
            ...
            className="p-2 rounded-2xl bg-white/15 hover:bg-white/25 text-white border border-white/20 transition-all shadow-xs cursor-pointer shrink-0"
          ...
          >
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl ring-2 ring-white/80 overflow-hidden bg-emerald-700 p-0.5 transition-transform group-hover:scale-105 shadow-xs">
              <img
                src={currentPhoto}
                alt={currentName}
